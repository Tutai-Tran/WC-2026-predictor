...
> Leak-free over **70** graded matches: outcome accuracy **69%**, Brier 0.469, log loss 0.7964. The biases below are hypotheses (the audit trail); the model's parameters are where learning is actually applied, only after it validates out-of-sample.
