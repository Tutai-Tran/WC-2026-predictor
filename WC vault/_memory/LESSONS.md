...
> Leak-free over **71** graded matches: outcome accuracy **69%**, Brier 0.4683, log loss 0.7957. The biases below are hypotheses (the audit trail); the model's parameters are where learning is actually applied, only after it validates out-of-sample.
